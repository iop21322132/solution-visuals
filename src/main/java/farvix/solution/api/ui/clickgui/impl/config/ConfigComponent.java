...
public class ConfigComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        ShapeProperties.create(context.getMatrices(), x, y, width, height)
                ...
                .color(hovered ? TempColor.getClientColor().alpha(0.05).getRGB() : 
                       TempColor.getGuiBackground().alpha(0.3).getRGB())
                .build();
        
        // Название конфига
        Fonts.DEFAULT.get(16).drawString(context.getMatrices(), config.name, 
                x + 15, y + 12, TempColor.getTextPrimary().getRGB());
        ...
        Fonts.DEFAULT.get(12).drawString(context.getMatrices(), "Last modified: " + dateStr, 
                x + 15, y + 30, TempColor.getTextSecondary().getRGB());
        ...
        ShapeProperties.create(context.getMatrices(), loadBtnX, btnY, btnWidth, btnHeight)
                .round(6)
                .color(loadHovered ? TempColor.getClientColor().alpha(0.4).getRGB() : 
                       TempColor.getClientColor().alpha(0.3).getRGB())
                .build();
        ...
        ShapeProperties.create(context.getMatrices(), deleteBtnX, btnY, btnWidth, btnHeight)
                .round(6)
                .color(deleteHovered ? new farvix.solution.api.util.color.FixColor(255, 50, 50).alpha(0.4).getRGB() : 
                       new farvix.solution.api.util.color.FixColor(255, 50, 50).alpha(0.2).getRGB())
                .build();
