...
public class UI extends Module {
    ...
    private final BooleanSetting clickGuiBlur = new BooleanSetting("setting.clickguiBlur", true);
    private final BooleanSetting clickGuiSnow = new BooleanSetting("setting.clickguiSnow", true);
    ...
    public boolean isClickGuiBlurEnabled() {
        return clickGuiBlur.getValue();
    }

    public boolean isClickGuiSnowEnabled() {
        return clickGuiSnow.getValue();
    }
}