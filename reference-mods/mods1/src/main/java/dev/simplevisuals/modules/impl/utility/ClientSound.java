...
public class ClientSound extends Module {
    ...
    private final @NotNull BooleanSetting default1 = new BooleanSetting("mode.default", true, () -> false);
    private final @NotNull BooleanSetting legacy1 = new BooleanSetting("mode.legacy1", false, () -> false);
    public final BooleanSetting clickguisound = new BooleanSetting("settind.clickguisound", true);
    ...
    private final @NotNull NumberSetting volumeclickgui = new NumberSetting(
            "setting.volumeclickgui",
            1.0f,
            0.0f,
            2.0f,
            0.01f
    ...
    private final @NotNull ListSetting mode1 = new ListSetting(
            "setting.sound1",
            true,
            default1, legacy1
    );
    ...
    public String getOnClickguiSoundId() {
        if (default1.getValue()) return "simplevisuals:openclickgui";
        return "simplevisuals:openclickgui1";
    }
    public String getOffClickguiSoundId() {
        if (default1.getValue()) return "simplevisuals:closeclickgui";
        return "simplevisuals:closeclickgui1";
    }

    public NumberSetting getVolume() {
        return volume;
    }
    public NumberSetting getVolumeClickgui() {
        return volumeclickgui;
    }
}
